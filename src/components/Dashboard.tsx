import { courses, banner } from '../data/courses';
  ...
  return (
    <div className="min-h-screen w-full overflow-x-hidden bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-800 transition-all duration-300">
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        ...
        {/* ⬇️ BANNER ANTES DOS PRODUTOS - CONDICIONAL */}
        <div className="w-full mb-8 sm:mb-12">
          {banner.link ? (
            ...
            <a 
              ...
              className="block w-full rounded-xl sm:rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] cursor-pointer"
            >
              <img 
                src={banner.imageUrl} 
                alt={banner.alt}
            ...
            // Se NÃO tiver link, o banner é apenas uma imagem
            <div className="block w-full rounded-xl sm:rounded-2xl overflow-hidden shadow-lg">
              <img 
                src={banner.imageUrl} 
                alt={banner.alt}
                className="w-full h-auto object-cover"
